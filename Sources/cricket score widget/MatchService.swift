...
class MatchService {
    ...
    func fetchUpdates() async {
        ...
        do {
            ...
            let liveAPIMatches = result.rawMatches.filter { MatchSelector.classify($0.state.description) == .live }
            ...
            await MainActor.run {
                ...
                self.currentMatch = selectionResult.selectedMatch
                ...
                if let selected = selectionResult.selectedMatch {
